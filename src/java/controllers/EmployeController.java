...
private Converter employeConverter;
    ...
    public Converter getEmployeConverter() {
        return employeConverter;
    }

    public void setEmployeConverter(Converter employeConverter) {
...
public void filterEmployees() {
    if (selectedEmployee != null) {
        // Filter logic here using the selectedEmployee value
        // You can perform a query or filter the displayed list of employees based on the selectedEmployee
        // Update the items list accordingly
    } else {
